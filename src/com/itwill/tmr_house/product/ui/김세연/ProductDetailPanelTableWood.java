...
public class ProductDetailPanelTableWood extends JPanel {
	 ...
	 * @throws Exception 
	 */
	public ProductDetailPanelTableWood() throws Exception {
		...
		productImgLabel.setIcon(new ImageIcon(ProductDetailPanelTableWood.class.getResource("/com/itwill/tmr_house/product/images/table_wood_square350.png")));
		
		JLabel productNameLabel = new JLabel("원목 사각 테이블");
...
//					System.out.println(cart_qty);
		...
		JLabel productDetailLabel = new JLabel("내추럴한 원목 테이블");
...
//				카트 페이지로 전환
		...
		JLabel priceDataLabel = new JLabel("90,000원");

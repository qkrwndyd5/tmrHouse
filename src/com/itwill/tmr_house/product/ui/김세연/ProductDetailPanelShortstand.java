...
public class ProductDetailPanelShortstand extends JPanel {
	 ...
	 * @throws Exception 
	 */
	public ProductDetailPanelShortstand() throws Exception {
		...
		productImgLabel.setHorizontalAlignment(SwingConstants.RIGHT);
		productImgLabel.setBounds(12, 60, 250, 350);
		productDetailPanel.add(productImgLabel);
		productImgLabel.setIcon(new ImageIcon(ProductDetailPanelShortstand.class.getResource("/com/itwill/tmr_house/product/images/lighting_short_table350.png")));
		
		JLabel productNameLabel = new JLabel("테이블 조명");
...
//					System.out.println(cart_qty);
		...
		JLabel productDetailLabel = new JLabel("탁상용 단스탠드. 지름 20cm, 높이 30cm");
...
//				카트 페이지로 전환
		...
		JLabel categoryLabel = new JLabel("조명 > 단스탠드");
		...
		JLabel priceDataLabel = new JLabel("10,000원");
